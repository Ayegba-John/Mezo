    ...
    <div className={styles.main}>
      <div className={styles.Wrapper}>
        <p>
          ...
          end-users who share the same core values as we do. In partnership with
          mezovest, we provide gas financing where we deliver high quality
          cooking gas to our vendors. Hundreds of small businesses have
          leveraged this credit system to grow their business as well as several
          stakeholders in the LPG value chain. Mezo Energy Image
        </p>
      </div>
    </div>
  );
